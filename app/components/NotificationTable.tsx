...
const columns = [
  ...
  columnHelper.accessor("status", {
    header: () => "ตรวจสอบ",
    cell: (info) => (
      <button className="w-[110px] h-[40px] text-[#fff] bg-[#8F8F8F] border border-[#8F8F8F] rounded-[20px]">
        รอจัดส่ง
      </button>
    ),
  }),
  columnHelper.accessor("notificationId", {
    ...
    header: "รายละเอียด",
    cell: (info) => (
      <button className="w-[110px] h-[40px] text-[#28B7E1] border border-[#28B7E1] rounded-[20px]">
        ดูรายละเอียด
      </button>
    ),
  }),
