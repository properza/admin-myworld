...
function PaginationNavigator ({ currentPage, totalPage, setPageIndex }: PaginationNavigatorProps): JSX.Element {
  ...
  return (
    <div className="h-10 justify-start items-start gap-1 inline-flex">
      {pages.map((page) => (
        ...
        >
          <div className={classNames(page === selectedPage ? "text-white" : "text-black", "text-sm font-normal font-inter")}>
            {page}
          </div>
        </button>
      ))}
