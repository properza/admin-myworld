...
export default function Topbar({ title, isSubRoute, returnRoute }: TopbarProps): JSX.Element {
  return (
    <div className="flex h-12 bg-blackrose px-7 py-2.5 justify-start items-center gap-2.5 relative z-10">
      ...
      <div className="flex items-center w-9 h-9 relative">
        <Link to="/notification"> <img src="/images/bell.svg" alt="Notification" draggable="false" /></Link>
      </div>
    </div>
  );
};
