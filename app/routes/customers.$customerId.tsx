...
import CustomerDetailsNavigation, { CustomerDetailRoute } from "~/components/CustomerDetailsNavigation";
...
function CustomerDetailsPage (): JSX.Element {
  ...
  return (
    <Layout title="สมาชิก" isSubRoute={true} returnRoute="/customers" pathname={location.pathname}>
      <div className="space-y-4">
        <CustomerDetailsCard customer={data.customer} showCustomerInfo={isOrderRoute} />
        <CustomerDetailsNavigation customerId={data.customerId} selectedRoute={getSelectedRoute()} />
